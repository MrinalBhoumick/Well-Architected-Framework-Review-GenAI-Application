...
well_architected_client = boto3.client('wellarchitected', region_name="ap-south-1")
...
def trigger_wafr_review(input_data):
    try:
        ...
        queue_url = 'wafrAcceleratorQueue-202506071648'
...
def create_wafr_analysis(analysis_data, uploaded_file):
    ...
    if uploaded_file:
        ...
        if not upload_to_s3(uploaded_file, "wafr-accelerator-upload-202506071648", s3_key):
    ...
    if message_id:
        ...
        wafr_accelerator_runs_table = dynamodb.Table('wafr-reviewruns-202506071648')

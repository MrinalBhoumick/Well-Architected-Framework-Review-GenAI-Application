...
def load_data():
    ...
    try:
        # Scan the table
        response = dynamodb.scan(TableName='wafr-reviewruns-202506071648')
        ...
        while 'LastEvaluatedKey' in response:
            response = dynamodb.scan(
                TableName='wafr-reviewruns-202506071648',
        ...
        if prompt:
            ...
            if("kbpxvaje8un8" == "Not Selected"):
                ...
                streaming_response = client.invoke_model_with_response_stream(
                    modelId=model_id,
                    body=body,
                    guardrailIdentifier="kbpxvaje8un8",
